...
# Racine du projet
# --------------------------
PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent  # Ajustez selon la profondeur du fichier
...
# --------------------------
# Fichiers originaux embeddings/chunks (pipeline preprocessing)
# --------------------------
