...
def hierarchical_clustering():
    ...
    # Save
    cluster_levels_df.to_csv(MODULE_DIR / "clusters_by_height_filtered.csv", index=False)
    ...
    to_cluster_df.to_csv(MODULE_DIR / "clustered_topics_tt.csv", index=False)
    # OR
    grouped_topics.to_json(MODULE_DIR / "grouped_topics_tt.json")


    # Save
    np.save(MODULE_DIR / "linked_matrix.npy", linked)
