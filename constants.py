...
###
ACTIVE_PROJECT = "dino_v2_proj"

# Project order - Most recently accessed projects will appear first
# Format: List of project names in display order
PROJECT_ORDER = ["dino_v2_proj", "celinev3", "eldino_proj", "dodo", "doni", "celinev2", "Projet Demo", "dinodelanight", "ledinovivra_proj", "newdino_proj", "dinofiable_proj", "diplodocus_proj", "din_proj", "dinosur_proj", "dinosisi", "ccccccc"]
