...
###
ACTIVE_PROJECT = "3_3pst"

# Project order - Most recently accessed projects will appear first
# Format: List of project names in display order
PROJECT_ORDER = ["3_3pst", "pst_test_graph", "Dino test", "celinev3", "dino_v2_proj", "pst_proj", "single_eml_proj", "dinodelanight", "joel_zip_full_proj", "joel_sample_v1", "Projet Demo", "eldino_proj", "dodo", "doni", "celinev2", "ledinovivra_proj", "newdino_proj", "dinofiable_proj", "diplodocus_proj", "din_proj", "dinosur_proj", "dinosisi", "ccccccc"]
