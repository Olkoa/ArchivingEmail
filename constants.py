...
PROJECT_ORDER = ["celinev3", "joel_sample_v1", "single_eml_proj", "Projet Demo", "eldino_proj", "pst_proj", "dino_v2_proj", "dodo", "doni", "celinev2", "dinodelanight", "ledinovivra_proj", "newdino_proj", "dinofiable_proj", "diplodocus_proj", "din_proj", "dinosur_proj", "dinosisi", "ccccccc"]
