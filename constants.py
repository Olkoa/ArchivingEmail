...
###
ACTIVE_PROJECT = "pst_proj"

# Project order - Most recently accessed projects will appear first
# Format: List of project names in display order
PROJECT_ORDER = ["pst_proj", "single_eml_proj", "celinev3", "dinodelanight", "dino_v2_proj", "joel_zip_full_proj", "joel_sample_v1", "Projet Demo", "eldino_proj", "dodo", "doni", "celinev2", "ledinovivra_proj", "newdino_proj", "dinofiable_proj", "diplodocus_proj", "din_proj", "dinosur_proj", "dinosisi", "ccccccc"]
